...
export const NotFound = () => {
  ...
  return (
    ...
    <div class="bg">
      <div className='error'>
      <h1 className='text-[#65D36E] text-[120px] font-bold'>404</h1> 
      <p className='text-[#fff] font-medium text-[22px]'>Something went wrong!</p>
      <button onClick={clearToken} className='text-[black] w-[200px] h-[50px] bg-[#fff] rounded-3xl text-[20px] font-bold border mt-[15px]'>Back</button>
